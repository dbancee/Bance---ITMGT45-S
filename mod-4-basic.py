...
def savings(gross_pay, tax_rate, expenses):
    ...
    takehome_savings = (gross_pay - round(gross_pay * tax_rate) - expenses)
    return(int(takehome_savings))
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    fin_material = total_material - consumed
    return(str(fin_material) + material_units)
